...
<input type="radio" class="form-check-input"  name="searchType" value="PENDING"> PENDING  <br/><br/>
</div>
...
<input type="submit" class="btn btn-secondary" value="View"><br/>
...
<div class="table-responsive-lg">
  <table class="table table-bordered text-center">
	  <thead class="table-dark">
		...
		<c:forEach var="order" items="${dao.searchCustomerOrder(cust.cust_id,param.searchType)}">
		<tr>
