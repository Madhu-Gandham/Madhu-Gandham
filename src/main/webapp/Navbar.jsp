      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
            <li><a class="dropdown-item" href="CustomerLogin.xhtml" class="click">Customer</a></li>
            <li><a class="dropdown-item" href="VendorLogin.xhtml" class="click">Vendor</a></li>
            <li><a class="dropdown-item" href="RestaurantLogin.xhtml" class="click">Restaurant</a></li>
          </ul>
        </li>
      </ul>
    </div>
