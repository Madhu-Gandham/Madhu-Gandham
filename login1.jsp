        ...
        <div class="container">
            <div class="signin-content">
                <div class="signin-image">
                    ...
                    <a href="addadmin.xhtml" class="signup-image-link">Create an account</a>
                </div>

                <div class="signin-form">
                    <h2 class="form-title">Admin-form</h2>
...
<div class="alert alert-danger" id="errorMsg" role="alert" style="color: red; display: none;"></div>
    ...
    <input type="submit" name="signin" id="signin" class="form-submit" value="Log in" onclick="validateForm(event)" />
                    ...
                    <div class="form-group">
                        <a href="resetpassword.jsp" class="forgot-password">Forgot Password</a>
                    </div>
		...
		<c:if test="${param.username != null && param.password != null }">
			<jsp:useBean id="beanAdmin" class="com.infinite.Library.Admin" />
			<jsp:setProperty property="*" name="beanAdmin" />
			<jsp:useBean id="beanDAO" class="com.infinite.Library.AdminDAO" />
